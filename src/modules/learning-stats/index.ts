          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                { tag: 'td', innerText: String(present.wordsTotal) },
                showLocked && { tag: 'td', innerText: String(additional.lockedWords) },
                { tag: 'td', innerText: String(newVocab) },
                { tag: 'td', innerText: String(dueVocab) },
                { tag: 'td', innerText: String(present.wordsLearning) },
                { tag: 'td', innerText: String(present.wordsKnown) },
            ...
            showWI && {
              ...
              children: [
                ...
                { tag: 'td', innerText: String(present.wordsIndirectTotal) },
                showLocked && { tag: 'td' },
                { tag: 'td' },
                { tag: 'td' },
                { tag: 'td', innerText: String(present.wordsIndirectLearning) },
                { tag: 'td', innerText: String(present.wordsIndirectKnown) },
            ...
            showK && {
              ...
              children: [
                ...
                { tag: 'td', innerText: String(present.kanjiTotal) },
                showLocked && { tag: 'td', innerText: String(additional.lockedKanji) },
                { tag: 'td', innerText: String(additional.newKanji) },
                { tag: 'td', innerText: String(additional.dueKanji) },
                { tag: 'td', innerText: String(present.kanjiLearning) },
                { tag: 'td', innerText: String(present.kanjiKnown) },
            ...
            showKI && {
              ...
              children: [
                ...
                { tag: 'td', innerText: String(present.kanjiIndirectTotal) },
                showLocked && { tag: 'td' },
                { tag: 'td' },
                { tag: 'td' },
                { tag: 'td', innerText: String(present.kanjiIndirectLearning) },
                { tag: 'td', innerText: String(present.kanjiIndirectKnown) },
            ...
            showSum && {
              ...
              children: [
                { tag: 'th' },
                { tag: 'td', innerText: String(additional.sumTotal) },
                showLocked && {
                  tag: 'td',
                  innerText: String(additional.lockedWords + additional.lockedKanji),
                },
                { tag: 'td', innerText: String(additional.new) },
                { tag: 'td', innerText: String(additional.due) },
                { tag: 'td', innerText: String(additional.sumLearning) },
                { tag: 'td', innerText: String(additional.sumKnown) },
            ...
            },
            {
              ...
              children: [
                ...
                { tag: 'td', innerText: String(additional.nonRedundant) },
                showLocked && { tag: 'td' },
                { tag: 'td' },
                { tag: 'td' },
                { tag: 'td' },
